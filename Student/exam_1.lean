...
-- inductive Sandwich : Type
-- | mk (bread : Bread) (spread_or_cheese : Sum Spread Cheese)

structure Sandwich : Type := (bread : Bread) (spread_or_cheese : Sum Spread Cheese)
...
def jam_sandwich : Sandwich := Sandwich.mk Bread.wheat (Sum.inl Spread.jam)
