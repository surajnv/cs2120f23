...
#eval nat_le 3 4 -- true
#eval nat_le 4 4 -- true
#eval nat_le 6 3 -- false
#eval nat_le 7 6 -- false
#eval nat_le 1 0 -- false
#eval nat_le 0 1 -- true
#eval nat_le 5 0 -- false
#eval nat_le 0 5 -- true
...
#eval mul 0 0 -- expect 0
#eval mul 1 0 -- expect 0
#eval mul 3 4 -- expect 12
#eval mul 3 3 -- expect 9
#eval mul 2 3 -- expect 6
#eval mul 3 0 -- expect 0
#eval mul 0 8 -- expect 0
...
#reduce sum_f (fun n => n) 3 -- expect 6
#reduce sum_f (fun n => n-1) 3 -- expect 3
#reduce sum_f (fun n => n*10) 5 -- expect 150
#reduce sum_f (fun n => n*n) 5  -- expect 55
#reduce sum_f (fun n => n*n) 4  -- expect 30
#reduce sum_f (fun n => (2*n)*(2*n)) 3  -- expect 56